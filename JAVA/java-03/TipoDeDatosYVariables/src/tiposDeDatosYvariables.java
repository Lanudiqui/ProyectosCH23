...
public class tiposDeDatosYvariables {
	public static void main(String[] args) {
        ...
        byte pago = 10;
        int pagoTotal = horasTrabajadas * pago;
        System.out.println("Su pago de las horas que trabo es: " + pagoTotal);
        ...
        * Los unicos que llevan letra al final son long, float y double
        ...
        int numInt = (int) num;
        System.out.println("Pasar a entero usando CAST " + numInt);
        long numLong = (long)num;
        System.out.println("Pasar a long usando CAST " + numLong);
